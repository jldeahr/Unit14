...
public class SelectionSorter
{
    ...
    {
        // repeatedly scan the unsorted portion of the array fo0r the next
        ...
        for (int i = 0; i < a.length - 1; i++)
        {
            ...
            // smallest value; update the smalles value and the index of that element
            ...
            // swap the smallest value with the element at the beginning of
